...
#line 76 "lexer.lxx"
            {
                strncpy(yylval.id, yytext, MAXIDLEN);
                return T_id;
            }
                YY_BREAK
...
#line 983 "lexer.cxx"
            ...
            case YY_STATE_EOF(COMM): yyterminate();
...
yy_ch_buf = (char *) yy_flex_alloc(b->yy_buf_size + 2);
