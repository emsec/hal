...
#define VER_BUFFER_SIZE        104857600    // 1M  - size of the data chunk stored in memory
#define VER_OFFSET_SIZE          6553600    // 64K - load new data when less than this is left
#define VER_WORD_SIZE            6553600    // 64K - the largest token that can be returned
