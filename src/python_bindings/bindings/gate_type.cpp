...
namespace hal
{
    void gate_type_init(py::module& m)
    {
        py::enum_<GateTypeProperty>(m, "GateTypeProperty", R"(
            ...
            .value("tristate", GateTypeProperty::tristate, R"(Tristate gate type.)")
            ...
            .value("c_nand", GateTypeProperty::c_nand, R"(NAND gate type.)")
            .value("c_or", GateTypeProperty::c_or, R"(OR gate type.)")
            .value("c_nor", GateTypeProperty::c_nor, R"(NOR gate type.)")
            .value("c_xor", GateTypeProperty::c_xor, R"(XOR gate type.)")
            .value("c_xnor", GateTypeProperty::c_xnor, R"(XNOR gate type.)")
            .value("c_aoi", GateTypeProperty::c_aoi, R"(AOI gate type.)")
            .value("c_oai", GateTypeProperty::c_oai, R"(OAI gate type.)")
            .value("c_mux", GateTypeProperty::c_mux, R"(MUX gate type.)")
            .value("c_carry", GateTypeProperty::c_carry, R"(Carry gate type.)")
            .value("c_half_adder", GateTypeProperty::c_half_adder, R"(Half adder gate type.)")
            .value("c_full_adder", GateTypeProperty::c_full_adder, R"(Full adder gate type.)")
            .value("c_lut", GateTypeProperty::c_lut, R"(LUT gate type.)")
            .export_values();
