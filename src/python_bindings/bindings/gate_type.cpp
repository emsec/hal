...
namespace hal
{
    void gate_type_init(py::module& m)
    {
        ...
        py_gate_type.def("get_boolean_function", py::overload_cast<const std::string&>(&GateType::get_boolean_function), py::arg("name"), R"(
        ...
        py_gate_type.def("get_boolean_function", py::overload_cast<const GatePin*>(&GateType::get_boolean_function), py::arg("pin") = nullptr, R"(
