...
namespace hal
{
    void boolean_function_init(py::module& m)
    {
        ...
        py_boolean_function.def_static(
            ...
            :returns: A string representing the values in the given base on success, an empty string on error.
            :rtype: str
        )");
        ...
        py_boolean_function.def_static(
            "And",
            [](BooleanFunction p0, BooleanFunction p1, u16 size) -> BooleanFunction {
            ...
            :returns: The joined Boolean function on success, an empty Boolean function otherwise.
            :rtype: hal_py.BooleanFunction
        )");
        ...
        py_boolean_function.def_static(
            "Not",
            [](BooleanFunction p0, u16 size) -> BooleanFunction {
            ...
            :param int size: Bit-size of the operation.
            :returns: The negated Boolean function on success, an empty Boolean function otherwise.
            :rtype: hal_py.BooleanFunction
        )");
        ...
        py_boolean_function.def(
            "substitute",
            [](const BooleanFunction& self, const std::string& variable_name, const BooleanFunction& function) -> BooleanFunction {
            ...
            :returns: The resulting Boolean function on success, an empty Boolean function otherwise.
            :rtype: hal_py.BooleanFunction
        )");

        py_boolean_function.def(
            "evaluate",
            [](const BooleanFunction& self, const std::unordered_map<std::string, BooleanFunction::Value>& inputs) -> BooleanFunction::Value {
            ...
            :returns: The resulting value on success, 'BooleanFunction.Value.X' otherwise.
            :rtype: hal_py.BooleanFunction.Value
        )");

        py_boolean_function.def(
            "evaluate",
            [](const BooleanFunction& self, const std::unordered_map<std::string, std::vector<BooleanFunction::Value>>& inputs) -> std::vector<BooleanFunction::Value> {
                auto res = self.evaluate(inputs);
                if (res.is_ok())
                {
                    return res.get();
            ...
            :returns: A vector of values on success, an empty vector otherwise.
            :rtype: list[hal_py.BooleanFunction.Value]
        )");

        py_boolean_function.def(
            "compute_truth_table",
            [](const BooleanFunction& self, const std::vector<std::string>& ordered_variables, bool remove_unknown_variables) -> std::vector<std::vector<BooleanFunction::Value>> {
