...
namespace hal
{
    void pin_group_init(py::module& m)
    {
        ...
        py_gate_pin_group.def_property_readonly("pins", &PinGroup<GatePin>::get_pins, R"(
        ...
        py_gate_pin_group.def(
            ...
            [](const PinGroup<GatePin>& self, u32 index) -> GatePin* {
                ...
                {
                    log_error("python_context", "error encountered while getting pin at index:\n{}", res.get_error().get());
                    return nullptr;
                }
            },
            py::arg("index"),
        ...
        py_gate_pin_group.def(
            ...
            [](const PinGroup<GatePin>& self, const GatePin* pin) -> i32 {
                ...
                {
                    log_error("python_context", "error encountered while getting index of pin\n{}", res.get_error().get());
                    return -1;
                }
            },
            py::arg("pin"),
