...
namespace hal
{
    void gate_library_parser_manager_init(py::module& m)
    {
        auto py_gate_library_parser_manager = m.def_submodule("GateLibraryParserManager", R"(
            HAL GateLibraryParserManager functions.
        )");

        py_gate_library_parser_manager.def(
            "load_file",
            [](std::filesystem::path path, bool reload_if_existing) { return RawPtrWrapper<GateLibrary>(gate_library_parser_manager::load_file(path, reload_if_existing)); },
            py::arg("path"),
        ...
        py_gate_library_parser_manager.def("load_all", &gate_library_parser_manager::load_all, py::arg("reload_if_existing"), R"(
        ...
        py_gate_library_parser_manager.def(
            "get_gate_library", [](const std::string& file_name) { return RawPtrWrapper<GateLibrary>(gate_library_parser_manager::get_gate_library(file_name)); }, py::arg("file_name"), R"(
        ...
        py_gate_library_parser_manager.def(
            ...
            [](const std::string& lib_name) { return RawPtrWrapper<GateLibrary>(gate_library_parser_manager::get_gate_library_by_name(lib_name)); },
            py::arg("lib_name"),
            R"(
        ...
        py_gate_library_parser_manager.def(
            ...
            [] {
                ...
                for (auto lib : gate_library_parser_manager::get_gate_libraries())
                {
