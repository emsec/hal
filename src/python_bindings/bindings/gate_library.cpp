...
namespace hal
{
    void gate_library_init(py::module& m)
    {
        ...
        // py_gate_library.def("create_gate_type", &GateLibrary::create_gate_type, py::arg("name"), py::arg("properties") = std::set<GateTypeProperty>(), py::return_value_policy::reference_internal, R"(
        ...
        py_gate_library.def("get_gate_type_by_name", &GateLibrary::get_gate_type_by_name, py::arg("name"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate_library.def_property_readonly("gate_types", [](const GateLibrary& self) { return self.get_gate_types(); }, py::return_value_policy::reference_internal, R"(
            All gate types of the gate library as as dict from gate type names to gate types.

            :type: dict[str,hal_py.GateType]
        )");

        py_gate_library.def("get_gate_types", &GateLibrary::get_gate_types, py::arg("filter") = nullptr, py::return_value_policy::reference_internal, R"(
        ...
        py_gate_library.def_property_readonly("vcc_gate_types", &GateLibrary::get_vcc_gate_types, py::return_value_policy::reference_internal, R"(
            All VCC gate types of the gate library as as dict from gate type names to gate types.

            :type: dict[str,hal_py.GateType]
        )");

        py_gate_library.def("get_vcc_gate_types", &GateLibrary::get_vcc_gate_types, py::return_value_policy::reference_internal, R"(
        ...
        py_gate_library.def_property_readonly("gnd_gate_types", &GateLibrary::get_vcc_gate_types, py::return_value_policy::reference_internal, R"(
            All GND gate types of the gate library as as dict from gate type names to gate types.

            :type: dict[str,hal_py.GateType]
        )");

        py_gate_library.def("get_gnd_gate_types", &GateLibrary::get_gnd_gate_types, py::return_value_policy::reference_internal, R"(
