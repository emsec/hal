...
namespace hal
{
    void netlist_init(py::module& m)
    {
        ...
        py_netlist.def("get_gate_by_id", &Netlist::get_gate_by_id, py::arg("gate_id"), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("gates", py::overload_cast<>(&Netlist::get_gates, py::const_), py::return_value_policy::reference_internal, R"(
            All gates contained within the netlist.

            :type: list[hal_py.Gate]
        )");

        py_netlist.def("get_gates", py::overload_cast<>(&Netlist::get_gates, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def("get_gates", py::overload_cast<const std::function<bool(const Gate*)>&>(&Netlist::get_gates, py::const_), py::arg("filter"), py::return_value_policy::reference_internal, R"(
            Get all gates contained within the netlist.
        ...
        py_netlist.def_property_readonly("vcc_gates", &Netlist::get_vcc_gates, py::return_value_policy::reference_internal, R"(
            All global VCC gates.

            :type: list[hal_py.Gate]
        )");

        py_netlist.def("get_vcc_gates", &Netlist::get_vcc_gates, py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("gnd_gates", &Netlist::get_gnd_gates, py::return_value_policy::reference_internal, R"(
            All global GND gates.

            :type: list[hal_py.Gate]
        )");

        py_netlist.def("get_gnd_gates", &Netlist::get_gnd_gates, py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("vcc_nets", &Netlist::get_vcc_nets, py::return_value_policy::reference_internal, R"(
            All global VCC nets.

            :type: list[hal_py.Net]
        )");

        py_netlist.def("get_vcc_nets", &Netlist::get_vcc_nets, py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("gnd_nets", &Netlist::get_gnd_nets, py::return_value_policy::reference_internal, R"(
            All global GND nets.

            :type: list[hal_py.Net]
        )");

        py_netlist.def("get_gnd_nets", &Netlist::get_gnd_nets, py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def("create_net", py::overload_cast<const u32, const std::string&>(&Netlist::create_net), py::arg("net_id"), py::arg("name"), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def("create_net", py::overload_cast<const std::string&>(&Netlist::create_net), py::arg("name"), py::return_value_policy::reference_internal, R"(
            Create a new net and add it to the netlist.
        ...
        py_netlist.def("get_net_by_id", &Netlist::get_net_by_id, py::arg("net_id"), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("nets", py::overload_cast<>(&Netlist::get_nets, py::const_), py::return_value_policy::reference_internal, R"(
            All nets contained within the netlist.

            :type: list[hal_py.Net]
        )");

        py_netlist.def("get_nets", py::overload_cast<>(&Netlist::get_nets, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def("get_nets", py::overload_cast<const std::function<bool(const Net*)>&>(&Netlist::get_nets, py::const_), py::arg("filter"), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("global_input_nets", &Netlist::get_global_input_nets, py::return_value_policy::reference_internal, R"(
            All global input nets.

            :type: list[hal_py.Net]
        )");

        py_netlist.def("get_global_input_nets", &Netlist::get_global_input_nets, py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("global_output_nets", &Netlist::get_global_output_nets, py::return_value_policy::reference_internal, R"(
            All global output nets.

            :type: list[hal_py.Net]
        )");

        py_netlist.def("get_global_output_nets", &Netlist::get_global_output_nets, py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def("get_module_by_id", &Netlist::get_module_by_id, py::arg("module_id"), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("modules", py::overload_cast<>(&Netlist::get_modules, py::const_), py::return_value_policy::reference_internal, R"(
            All modules contained within the netlist, including the top module.

            :type: list[hal_py.Module]
        )");

        py_netlist.def("get_modules", py::overload_cast<>(&Netlist::get_modules, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def("get_modules", py::overload_cast<const std::function<bool(const Module*)>&>(&Netlist::get_modules, py::const_), py::arg("filter"), py::return_value_policy::reference_internal, R"(
            Get all modules contained within the netlist, including the top module.
        ...
        py_netlist.def_property_readonly("top_module", &Netlist::get_top_module, py::return_value_policy::reference_internal, R"(
            The top module of the netlist.

            :type: hal_py.Module
        )");

        py_netlist.def("get_top_module", &Netlist::get_top_module, py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def("get_grouping_by_id", &Netlist::get_grouping_by_id, py::arg("grouping_id"), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def_property_readonly("groupings", py::overload_cast<>(&Netlist::get_groupings, py::const_), py::return_value_policy::reference_internal, R"(
            All groupings contained within the netlist.

            :type: list[hal_py.Grouping]
        )");

        py_netlist.def("get_groupings", py::overload_cast<>(&Netlist::get_groupings, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_netlist.def("get_groupings", py::overload_cast<const std::function<bool(const Grouping*)>&>(&Netlist::get_groupings, py::const_), py::arg("filter"), py::return_value_policy::reference_internal, R"(
            Get all groupings contained within the netlist.
