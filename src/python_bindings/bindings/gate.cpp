...
namespace hal
{
    void gate_init(py::module& m)
    {
        ...
        py_gate.def_property_readonly("module", &Gate::get_module, py::return_value_policy::reference_internal, R"(
            The module in which contains this gate.

            :type: hal_py.Module
        )");

        py_gate.def("get_module", &Gate::get_module, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("modules", [](Gate* g) { return g->get_modules(); }, py::return_value_policy::reference_internal, R"(
            A list of all modules that contain this gate, either directly or as parent of another module.

            :type: list[hal_py.Module]
        )");

        py_gate.def("get_modules", &Gate::get_modules, py::arg("filter") = nullptr, py::arg("recursive") = true, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_grouping", &Gate::get_grouping, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("fan_in_nets", py::overload_cast<>(&Gate::get_fan_in_nets, py::const_), py::return_value_policy::reference_internal, R"(
            A list of all fan-in nets of the gate, i.e., all nets that are connected to one of the input pins.

            :type: list[hal_py.Net]
        )");

        py_gate.def("get_fan_in_nets", py::overload_cast<>(&Gate::get_fan_in_nets, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_in_nets", py::overload_cast<const std::function<bool(Net*)>&>(&Gate::get_fan_in_nets, py::const_), py::arg("filter"), py::return_value_policy::reference_internal, R"(
            Get a list of all fan-in nets of the gate, i.e., all nets that are connected to one of the input pins.
        ...
        py_gate.def("get_fan_in_net", py::overload_cast<const std::string&>(&Gate::get_fan_in_net, py::const_), py::arg("pin_name"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_in_net", py::overload_cast<const GatePin*>(&Gate::get_fan_in_net, py::const_), py::arg("pin"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("fan_in_endpoints", py::overload_cast<>(&Gate::get_fan_in_endpoints, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_in_endpoints", py::overload_cast<>(&Gate::get_fan_in_endpoints, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_in_endpoints", py::overload_cast<const std::function<bool(Endpoint*)>&>(&Gate::get_fan_in_endpoints, py::const_), py::arg("filter"), py::return_value_policy::reference_internal, R"(
            Get a list of all fan-in endpoints of the gate, i.e., all endpoints associated with an input pin of the gate.
            The filter is evaluated on every candidate such that the result only contains those matching the specified condition.
        ...
        py_gate.def("get_fan_in_endpoint", py::overload_cast<const std::string&>(&Gate::get_fan_in_endpoint, py::const_), py::arg("pin_name"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_in_endpoint", py::overload_cast<const GatePin*>(&Gate::get_fan_in_endpoint, py::const_), py::arg("pin"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_in_endpoint", py::overload_cast<const Net*>(&Gate::get_fan_in_endpoint, py::const_), py::arg("net"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("fan_out_nets", py::overload_cast<>(&Gate::get_fan_out_nets, py::const_), py::return_value_policy::reference_internal, R"(
            A list of all fan-out nets of the gate, i.e., all nets that are connected to one of the output pins.

            :type: list[hal_py.Net]
        )");

        py_gate.def("get_fan_out_nets", py::overload_cast<>(&Gate::get_fan_out_nets, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_out_nets", py::overload_cast<const std::function<bool(Net*)>&>(&Gate::get_fan_out_nets, py::const_), py::arg("filter"), py::return_value_policy::reference_internal, R"(
            Get a list of all fan-out nets of the gate, i.e., all nets that are connected to one of the output pins.
            The filter is evaluated on every candidate such that the result only contains those matching the specified condition.
        ...
        py_gate.def("get_fan_out_net", py::overload_cast<const std::string&>(&Gate::get_fan_out_net, py::const_), py::arg("pin_name"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_out_net", py::overload_cast<const GatePin*>(&Gate::get_fan_out_net, py::const_), py::arg("pin"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("fan_out_endpoints", py::overload_cast<>(&Gate::get_fan_out_endpoints, py::const_), py::return_value_policy::reference_internal, R"(
            A list of all fan-out endpoints of the gate, i.e., all endpoints associated with an output pin of the gate.

            :type: list[hal_py.Endpoint]
        )");

        py_gate.def("get_fan_out_endpoints", py::overload_cast<>(&Gate::get_fan_out_endpoints, py::const_), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_out_endpoints", py::overload_cast<const std::function<bool(Endpoint*)>&>(&Gate::get_fan_out_endpoints, py::const_), py::arg("filter"), py::return_value_policy::reference_internal, R"(
            Get a list of all fan-out endpoints of the gate, i.e., all endpoints associated with an output pin of the gate.
            The filter is evaluated on every candidate such that the result only contains those matching the specified condition.
        ...
        py_gate.def("get_fan_out_endpoint", py::overload_cast<const std::string&>(&Gate::get_fan_out_endpoint, py::const_), py::arg("pin_name"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_out_endpoint", py::overload_cast<const GatePin*>(&Gate::get_fan_out_endpoint, py::const_), py::arg("pin"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_fan_out_endpoint", py::overload_cast<const Net*>(&Gate::get_fan_out_endpoint, py::const_), py::arg("net"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("unique_predecessors", [](Gate* g) { return g->get_unique_predecessors(); }, py::return_value_policy::reference_internal, R"(
            A list of all unique predecessor gates of the gate.

            :type: list[hal_py.Gate]
        )");

        py_gate.def("get_unique_predecessors", &Gate::get_unique_predecessors, py::arg("filter") = nullptr, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("predecessors", [](Gate* g) { return g->get_predecessors(); }, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_predecessors", &Gate::get_predecessors, py::arg("filter") = nullptr, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_predecessor", py::overload_cast<const std::string&>(&Gate::get_predecessor, py::const_), py::arg("pin_name"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_predecessor", py::overload_cast<const GatePin*>(&Gate::get_predecessor, py::const_), py::arg("pin"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("unique_successors", [](Gate* g) { return g->get_unique_successors(); }, py::return_value_policy::reference_internal, R"(
            A list of all unique successor gates of the gate.

            :type: list[hal_py.Gate]
        )");

        py_gate.def("get_unique_successors", &Gate::get_unique_successors, py::arg("filter") = nullptr, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def_property_readonly("successors", [](Gate* g) { return g->get_successors(); }, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_successors", &Gate::get_successors, py::arg("filter") = nullptr, py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_successor", py::overload_cast<const std::string&>(&Gate::get_successor, py::const_), py::arg("pin_name"), py::return_value_policy::reference_internal, R"(
        ...
        py_gate.def("get_successor", py::overload_cast<const GatePin*>(&Gate::get_successor, py::const_), py::arg("pin"), py::return_value_policy::reference_internal, R"(
            Get a single direct successor endpoint that is connected to the output pin specified by name.
            Fails if there are no or more than one successors.
