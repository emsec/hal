...
namespace hal
{
    void net_init(py::module& m)
    {
        ...
        py_net.def("get_grouping", &Net::get_grouping, py::return_value_policy::reference_internal, R"(
        ...
        py_net.def("add_source", py::overload_cast<Gate*, const std::string&>(&Net::add_source), py::arg("gate"), py::arg("pin_name"), py::return_value_policy::reference_internal, R"(
        ...
        py_net.def("add_source", py::overload_cast<Gate*, GatePin*>(&Net::add_source), py::arg("gate"), py::arg("pin"), py::return_value_policy::reference_internal, R"(
            Add a source endpoint to the net.
        ...
        py_net.def_property_readonly("sources", [](Net* n) { return n->get_sources(); }, py::return_value_policy::reference_internal, R"(
            A list of sources of the net.

            :type: list[hal_py.Endpoint]
        )");

        py_net.def("get_sources", &Net::get_sources, py::arg("filter") = nullptr, py::return_value_policy::reference_internal, R"(
        ...
        py_net.def("add_destination", py::overload_cast<Gate*, const std::string&>(&Net::add_destination), py::arg("gate"), py::arg("pin_name"), py::return_value_policy::reference_internal, R"(
        ...
        py_net.def("add_destination", py::overload_cast<Gate*, GatePin*>(&Net::add_destination), py::arg("gate"), py::arg("pin"), py::return_value_policy::reference_internal, R"(
            Add a destination endpoint to the net.
        ...
        py_net.def_property_readonly("destinations", [](Net* n) { return n->get_destinations(); }, py::return_value_policy::reference_internal, R"(
            A list of destinations of the net.

            :type: list[hal_py.Endpoint]
        )");

        py_net.def("get_destinations", &Net::get_destinations, py::arg("filter") = nullptr, py::return_value_policy::reference_internal, R"(
