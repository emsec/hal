...
namespace hal
{
    ...
    {
        return (t == interface_type::base) || (t == interface_type::cli && dynamic_cast<const i_cli*>(this)) || (t == interface_type::interactive_ui && dynamic_cast<const i_interactive_ui*>(this))
