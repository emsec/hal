...
namespace hal
{
    ...
    Gate* Netlist::create_gate(const u32 id, const GateType* gt, const std::string& name, i32 x, i32 y)
    {
        return m_manager->create_gate(id, gt, name, x, y);
    }

    Gate* Netlist::create_gate(const GateType* gt, const std::string& name, i32 x, i32 y)
    {
