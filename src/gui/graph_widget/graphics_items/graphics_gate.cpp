...
graphics_gate::graphics_gate(std::shared_ptr<gate> g) : graphics_node(item_type::gate, g->get_id(), QString::fromStdString(g->get_name())), m_type(QString::fromStdString(g->get_type()->get_name()))
{
