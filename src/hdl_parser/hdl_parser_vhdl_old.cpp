...
hdl_parser_vhdl_old::hdl_parser_vhdl_old(std::stringstream& stream) : hdl_parser(stream)
{
}

std::shared_ptr<netlist> hdl_parser_vhdl_old::parse(const std::string& gate_library)
{
...
bool hdl_parser_vhdl_old::parse_header(const std::vector<std::tuple<int, std::string>>& header)
{
...
bool hdl_parser_vhdl_old::parse_entity(const std::vector<std::tuple<int, std::string>>& entity)
{
...
bool hdl_parser_vhdl_old::parse_architecture(const std::vector<std::tuple<int, std::string>>& architecture)
{
...
bool hdl_parser_vhdl_old::parse_instances(const std::vector<std::tuple<int, std::string>>& instances)
{
    std::string instance;
...
std::string hdl_parser_vhdl_old::get_hex_from_number_literal(const std::string& v)
{
...
std::vector<std::string> hdl_parser_vhdl_old::get_vector_signals(const std::string& name, const std::string& type)
{
...
std::vector<std::string> hdl_parser_vhdl_old::get_port_assignments(const std::string& line)
{
    // a port may be
    // (1): a => ...
    // (2): a(x) => ...
