        ...
        TEST_START
            {
                ...
                EXPECT_EQ(gt_asc->get_base_types(), std::set<GateType::BaseType>({GateType::BaseType::lut, GateType::BaseType::combinational}));
                ...
                EXPECT_EQ(gt_desc->get_base_types(), std::set<GateType::BaseType>({GateType::BaseType::lut, GateType::BaseType::combinational}));
    ...
    TEST_F(LibertyParserTest, check_invalid_input) {
        TEST_START
            ...
            // }
            {
                ...
                EXPECT_EQ(gate_types.at("TEST_GATE_TYPE")->get_base_types(), std::set<GateType::BaseType>({GateType::BaseType::combinational}));
            }
            {
                // Define a pin twice
                NO_COUT_TEST_BLOCK;
