        ...
        TEST_START
            {
                ...
                EXPECT_EQ(gt_asc->get_base_types(), std::set<GateTypeProperty>({GateTypeProperty::lut, GateTypeProperty::combinational}));
                ...
                EXPECT_EQ(gt_desc->get_base_types(), std::set<GateTypeProperty>({GateTypeProperty::lut, GateTypeProperty::combinational}));
        ...
        TEST_START
            {
                ...
                ASSERT_TRUE(gt_it != gate_types.end());
                GateType* gt = gt_it->second;
                EXPECT_EQ(gt->get_base_types(), std::set<GateTypeProperty>({GateTypeProperty::sequential, GateTypeProperty::ff}));
        ...
        TEST_START
            {
                ...
                ASSERT_TRUE(gt_it != gate_types.end());
                GateType* gt = gt_it->second;
                EXPECT_EQ(gt->get_base_types(), std::set<GateTypeProperty>({GateTypeProperty::sequential, GateTypeProperty::latch}));
    ...
    TEST_F(LibertyParserTest, check_invalid_input) {
        TEST_START
            ...
            // }
            {
                ...
                EXPECT_EQ(gate_types.at("TEST_GATE_TYPE")->get_base_types(), std::set<GateTypeProperty>({GateTypeProperty::combinational}));
            }
            {
                // Define a pin twice
                NO_COUT_TEST_BLOCK;
