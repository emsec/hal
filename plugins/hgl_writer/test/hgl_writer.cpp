    ...
    namespace
    {
        static std::unique_ptr<GateLibrary> create_gate_library(const std::filesystem::path& file_path)
        {
...

            {
                ...
                gt->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("A & B")));
                gt->add_boolean_function("O_undefined", std::get<BooleanFunction>(BooleanFunction::from("!A & B")));
                gt->add_boolean_function("O_tristate", std::get<BooleanFunction>(BooleanFunction::from("!A & !B")));
            }

            {
                ...
                gt->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("A(1) & B(0)")));
                gt->add_boolean_function("O_undefined", std::get<BooleanFunction>(BooleanFunction::from("!A(0) & B(0)")));
                gt->add_boolean_function("O_tristate", std::get<BooleanFunction>(BooleanFunction::from("!A(1) & !B(1)")));
            }
            ...
            {
                GateType* gt = gl->create_gate_type("gt_ff", {GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), BooleanFunction::Var("D"), std::get<BooleanFunction>(BooleanFunction::from("CLK & EN"))));
            ...
            {
                GateType* gt = gl->create_gate_type("gt_ff_init", {GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(GateTypeComponent::create_init_component("generic", {"INIT"}), "IQ", "IQN"), BooleanFunction::Var("D"), std::get<BooleanFunction>(BooleanFunction::from("CLK & EN"))));
                FFComponent* ff_component = gt->get_component_as<FFComponent>([](const GateTypeComponent* component){ return component->get_type() == GateTypeComponent::ComponentType::ff; });
                assert(ff_component != nullptr);
