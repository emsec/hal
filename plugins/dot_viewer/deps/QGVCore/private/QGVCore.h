...
public:
    ...
    static QPainterPath toPath(const QString& shape, const polygon_t *poly, qreal width, qreal height);
...
private:
    static QPainterPath cylinder(const QPolygonF& polygon, qreal width, qreal height);
};
