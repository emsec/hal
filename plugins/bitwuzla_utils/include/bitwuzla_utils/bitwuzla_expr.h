...
//                 static expr SLICE(expr expr1, u64 start, u64 end);
//                 static expr ZEXT(expr expr1, u64 size);
//                 static expr SEXT(expr expr1, u64 size);
//                 static expr SHL(expr expr1, expr expr2);
//                 static expr LSHR(expr expr1, expr expr2);
//                 static expr ASHR(expr expr1, expr expr2);
//                 static expr ROR(expr expr1, u64 amount);
//                 static expr ROL(expr expr1, u64 amount);
