        ...
        TEST_START
            {
                ...
                // combinational gate type
                {
                    ...
                    EXPECT_EQ(functions.at("O"), std::get<BooleanFunction>(BooleanFunction::from("A & B")));
                    EXPECT_NE(functions.find("O_undefined"), functions.end());
                    EXPECT_EQ(functions.at("O_undefined"), std::get<BooleanFunction>(BooleanFunction::from("!A & B")));
                    EXPECT_NE(functions.find("O_tristate"), functions.end());
                    EXPECT_EQ(functions.at("O_tristate"), std::get<BooleanFunction>(BooleanFunction::from("!A & !B")));
                ...
                // combinational group gate type
                {
                    ...
                    ASSERT_EQ(functions.at("O"), std::get<BooleanFunction>(BooleanFunction::from("A(1) & B(0)")));
                    ASSERT_NE(functions.find("O_undefined"), functions.end());
                    ASSERT_EQ(functions.at("O_undefined"), std::get<BooleanFunction>(BooleanFunction::from("!A(0) & B(0)")));
                    ASSERT_NE(functions.find("O_tristate"), functions.end());
                    ASSERT_EQ(functions.at("O_tristate"), std::get<BooleanFunction>(BooleanFunction::from("!A(1) & !B(1)")));
                ...
                // FF gate type without initialization
                {
                    ...
                    EXPECT_EQ(ff_component->get_next_state_function(), std::get<BooleanFunction>(BooleanFunction::from("D")));
                    EXPECT_EQ(ff_component->get_clock_function(), std::get<BooleanFunction>(BooleanFunction::from("CLK & EN")));
                    EXPECT_EQ(ff_component->get_async_reset_function(), std::get<BooleanFunction>(BooleanFunction::from("R")));
                    EXPECT_EQ(ff_component->get_async_set_function(), std::get<BooleanFunction>(BooleanFunction::from("S")));
