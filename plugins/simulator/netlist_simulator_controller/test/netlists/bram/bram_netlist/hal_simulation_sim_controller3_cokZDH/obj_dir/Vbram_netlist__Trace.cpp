...
void Vbram_netlist::traceChgThis__7(Vbram_netlist__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBit(c+137,(vlTOPp->raddr_4));
        vcdp->chgBit(c+145,(vlTOPp->mask_6));
        vcdp->chgBit(c+153,(vlTOPp->din_1));
        vcdp->chgBit(c+161,(vlTOPp->mask_2));
        vcdp->chgBit(c+169,(vlTOPp->mask_8));
        vcdp->chgBit(c+177,(vlTOPp->waddr_0));
        vcdp->chgBit(c+185,(vlTOPp->read_en));
        vcdp->chgBit(c+193,(vlTOPp->raddr_7));
        vcdp->chgBit(c+201,(vlTOPp->waddr_2));
        vcdp->chgBit(c+209,(vlTOPp->mask_13));
        vcdp->chgBit(c+217,(vlTOPp->waddr_1));
        vcdp->chgBit(c+225,(vlTOPp->waddr_3));
        vcdp->chgBit(c+233,(vlTOPp->mask_9));
        vcdp->chgBit(c+241,(vlTOPp->mask_10));
        vcdp->chgBit(c+249,(vlTOPp->din_15));
        vcdp->chgBit(c+257,(vlTOPp->din_9));
        vcdp->chgBit(c+265,(vlTOPp->din_7));
        vcdp->chgBit(c+273,(vlTOPp->din_0));
        vcdp->chgBit(c+281,(vlTOPp->raddr_5));
        vcdp->chgBit(c+289,(vlTOPp->wclke));
        vcdp->chgBit(c+297,(vlTOPp->mask_4));
        vcdp->chgBit(c+305,(vlTOPp->mask_7));
        vcdp->chgBit(c+313,(vlTOPp->waddr_5));
        vcdp->chgBit(c+321,(vlTOPp->raddr_6));
        vcdp->chgBit(c+329,(vlTOPp->waddr_7));
        vcdp->chgBit(c+337,(vlTOPp->mask_15));
        vcdp->chgBit(c+345,(vlTOPp->din_3));
        vcdp->chgBit(c+353,(vlTOPp->mask_5));
        vcdp->chgBit(c+361,(vlTOPp->clk));
        vcdp->chgBit(c+369,(vlTOPp->din_8));
        vcdp->chgBit(c+377,(vlTOPp->raddr_0));
        vcdp->chgBit(c+385,(vlTOPp->din_6));
        vcdp->chgBit(c+393,(vlTOPp->din_13));
        vcdp->chgBit(c+401,(vlTOPp->mask_0));
        vcdp->chgBit(c+409,(vlTOPp->mask_11));
        vcdp->chgBit(c+417,(vlTOPp->mask_14));
        vcdp->chgBit(c+425,(vlTOPp->raddr_1));
        vcdp->chgBit(c+433,(vlTOPp->mask_1));
        vcdp->chgBit(c+441,(vlTOPp->write_en));
        vcdp->chgBit(c+449,(vlTOPp->raddr_2));
        vcdp->chgBit(c+457,(vlTOPp->rclke));
        vcdp->chgBit(c+465,(vlTOPp->din_10));
        vcdp->chgBit(c+473,(vlTOPp->din_12));
        vcdp->chgBit(c+481,(vlTOPp->raddr_3));
        vcdp->chgBit(c+489,(vlTOPp->din_14));
        vcdp->chgBit(c+497,(vlTOPp->mask_3));
        vcdp->chgBit(c+505,(vlTOPp->din_2));
        vcdp->chgBit(c+513,(vlTOPp->din_5));
        vcdp->chgBit(c+521,(vlTOPp->din_4));
        vcdp->chgBit(c+529,(vlTOPp->waddr_6));
        vcdp->chgBit(c+537,(vlTOPp->waddr_4));
        vcdp->chgBit(c+545,(vlTOPp->din_11));
        vcdp->chgBit(c+553,(vlTOPp->mask_12));
        vcdp->chgBit(c+561,(vlTOPp->dout_10));
        vcdp->chgBit(c+569,(vlTOPp->dout_15));
        vcdp->chgBit(c+577,(vlTOPp->dout_7));
        vcdp->chgBit(c+585,(vlTOPp->dout_5));
        vcdp->chgBit(c+593,(vlTOPp->dout_8));
        vcdp->chgBit(c+601,(vlTOPp->dout_0));
        vcdp->chgBit(c+609,(vlTOPp->dout_2));
        vcdp->chgBit(c+617,(vlTOPp->dout_13));
        vcdp->chgBit(c+625,(vlTOPp->dout_3));
        vcdp->chgBit(c+633,(vlTOPp->dout_14));
        vcdp->chgBit(c+641,(vlTOPp->dout_9));
        vcdp->chgBit(c+649,(vlTOPp->dout_1));
        vcdp->chgBit(c+657,(vlTOPp->dout_4));
        vcdp->chgBit(c+665,(vlTOPp->dout_11));
        vcdp->chgBit(c+673,(vlTOPp->dout_6));
        vcdp->chgBit(c+681,(vlTOPp->dout_12));
    }
}
