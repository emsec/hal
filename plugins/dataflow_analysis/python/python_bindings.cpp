...
namespace hal
{
    ...
    PYBIND11_PLUGIN(dataflow)
    {
        ...
        py_dataflow_configuration.def_readwrite("gate_types", &dataflow::Configuration::gate_types, py::return_value_policy::reference_internal, R"(
        ...
        py_dataflow_result.def("get_gates", &dataflow::Result::get_gates, py::return_value_policy::reference_internal, R"(
