        ...
        TEST_START
            {
                ...
                {    
                    ...
                    top_module->set_port_name(top_module->get_port(net_4_out), net_4_out->get_name());

                    Net* net_5_out = test_utils::connect_global_out(nl.get(), gate_5, "O", "net_5_out");
                    top_module->set_port_name(top_module->get_port(net_5_out), net_5_out->get_name());

                    Net* net_7_out = test_utils::connect_global_out(nl.get(), gate_7, "O", "net_7_out");
                    top_module->set_port_name(top_module->get_port(net_7_out), net_7_out->get_name());
                }
        ...
        TEST_START
            {
                ...
                {   
                    ...
                    top_module->set_port_name(top_module->get_port(global_in_0), global_in_0->get_name());
                    ...
                    top_module->set_port_name(top_module->get_port(global_in_1), global_in_1->get_name());
                    ...
                    top_module->set_port_name(top_module->get_port(global_out_0), global_out_0->get_name());
                    ...
                    top_module->set_port_name(top_module->get_port(global_out_1), global_out_1->get_name());
                }
        ...
        TEST_START
            {
                ...
                for (u32 i = 0; i < 4; i++)
                {
                    ...
                    top_module->set_port_name(top_module->get_port(n), "DATA_IN(" + std::to_string(i) + ")");

                    n = test_utils::connect_global_out(nl.get(), gate, "DATA_OUT(" + std::to_string(i) + ")", "DATA_OUT(" + std::to_string(i) + ")");
                    top_module->set_port_name(top_module->get_port(n), "DATA_OUT(" + std::to_string(i) + ")");

                    n = test_utils::connect_global_in(nl.get(), gate, "ADDR(" + std::to_string(i) + ")", "ADDR(" + std::to_string(i) + ")");
                    top_module->set_port_name(top_module->get_port(n), "ADDR(" + std::to_string(i) + ")");
                }
