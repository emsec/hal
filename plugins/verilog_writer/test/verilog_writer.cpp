        ...
        TEST_START
            {
                ...
                {   
                    ...
                    top_module->set_pin_name(top_module->get_pin(global_in_0), global_in_0->get_name());
                    ...
                    top_module->set_pin_name(top_module->get_pin(global_in_1), global_in_1->get_name());
                    ...
                    top_module->set_pin_name(top_module->get_pin(global_out_0), global_out_0->get_name());
                    ...
                    top_module->set_pin_name(top_module->get_pin(global_out_1), global_out_1->get_name());
                }
        ...
        TEST_START
            {
                ...
                for (u32 i = 0; i < 4; i++)
                {
                    ...
                    top_module->set_pin_name(top_module->get_pin(n), "DATA_IN(" + std::to_string(i) + ")");

                    n = test_utils::connect_global_out(nl.get(), gate, "DATA_OUT(" + std::to_string(i) + ")", "DATA_OUT(" + std::to_string(i) + ")");
                    top_module->set_pin_name(top_module->get_pin(n), "DATA_OUT(" + std::to_string(i) + ")");

                    n = test_utils::connect_global_in(nl.get(), gate, "ADDR(" + std::to_string(i) + ")", "ADDR(" + std::to_string(i) + ")");
                    top_module->set_pin_name(top_module->get_pin(n), "ADDR(" + std::to_string(i) + ")");
                }
