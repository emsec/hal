...
namespace hal
{
    ...
    {
        bool UtilsiCE40Ultra::is_sequential(GateType* g) const
        {
        ...
        std::unordered_set<std::string> UtilsiCE40Ultra::get_control_input_pin_types(GateType* g) const
        {
        ...
        std::unordered_set<std::string> UtilsiCE40Ultra::get_clock_ports(GateType* g) const
        {
            if (!is_sequential(g))
            {
        ...
        std::unordered_set<std::string> UtilsiCE40Ultra::get_enable_ports(GateType* g) const
        {
            if (!is_sequential(g))
            {
                log_error("gl specifics", "gate type is not sequential: type: {}", g->get_name());
        ...
        std::unordered_set<std::string> UtilsiCE40Ultra::get_reset_ports(GateType* g) const
        {
            if (!is_sequential(g))
            {
                log_error("gl specifics", "gate type is not sequential: type: {}", g->get_name());
        ...
        std::unordered_set<std::string> UtilsiCE40Ultra::get_set_ports(GateType* g) const
        {
            if (!is_sequential(g))
            {
                log_error("gl specifics", "gate type is not sequential: type: {}", g->get_name());
            ...
            {
                gate_to_set_ports["SB_DFF"]     = {};
                gate_to_set_ports["SB_DFFE"]    = {};
                gate_to_set_ports["SB_DFFSR"]   = {};
                gate_to_set_ports["SB_DFFR"]    = {};
                gate_to_set_ports["SB_DFFSS"]   = {"S"};
                gate_to_set_ports["SB_DFFS"]    = {"S"};
                gate_to_set_ports["SB_DFFESR"]  = {};
                gate_to_set_ports["SB_DFFER"]   = {};
                gate_to_set_ports["SB_DFFESS"]  = {"S"};
                gate_to_set_ports["SB_DFFES"]   = {"S"};
                gate_to_set_ports["SB_DFFN"]    = {};
                gate_to_set_ports["SB_DFFNE"]   = {};
                gate_to_set_ports["SB_DFFNSR"]  = {};
                gate_to_set_ports["SB_DFFNR"]   = {};
                gate_to_set_ports["SB_DFFNSS"]  = {"S"};
                gate_to_set_ports["SB_DFFNS"]   = {"S"};
                gate_to_set_ports["SB_DFFNESR"] = {};
                gate_to_set_ports["SB_DFFNER"]  = {};
                gate_to_set_ports["SB_DFFNESS"] = {"S"};
                gate_to_set_ports["SB_DFFNES"]  = {"S"};
            }

            return gate_to_set_ports.at(g->get_name());
        }

        std::unordered_set<std::string> UtilsiCE40Ultra::get_data_ports(GateType* g) const
        {
            if (!is_sequential(g))
            {
                log_error("gl specifics", "gate type is not sequential: type: {}", g->get_name());
            ...
            if (gate_to_data_ports.empty())
            {
                ...
                gate_to_data_ports["SB_DFFSS"]   = {"D"};
                gate_to_data_ports["SB_DFFS"]    = {"D"};
                gate_to_data_ports["SB_DFFESR"]  = {"D"};
                gate_to_data_ports["SB_DFFER"]   = {"D"};
                gate_to_data_ports["SB_DFFESS"]  = {"D"};
                gate_to_data_ports["SB_DFFES"]   = {"D"};
                gate_to_data_ports["SB_DFFN"]    = {"D"};
                gate_to_data_ports["SB_DFFNE"]   = {"D"};
                gate_to_data_ports["SB_DFFNSR"]  = {"D"};
                gate_to_data_ports["SB_DFFNR"]   = {"D"};
                gate_to_data_ports["SB_DFFNSS"]  = {"D"};
                gate_to_data_ports["SB_DFFNS"]   = {"D"};
                gate_to_data_ports["SB_DFFNESR"] = {"D"};
                gate_to_data_ports["SB_DFFNER"]  = {"D"};
                gate_to_data_ports["SB_DFFNESS"] = {"D"};
                gate_to_data_ports["SB_DFFNES"]  = {"D"};
        ...
        std::unordered_set<std::string> UtilsiCE40Ultra::get_regular_outputs(GateType* g) const
        {
            if (!is_sequential(g))
            {
                log_error("gl specifics", "gate type is not sequential: type: {}", g->get_name());
            ...
            {
                gate_to_regular_output_ports["SB_DFF"]     = {"Q"};
                gate_to_regular_output_ports["SB_DFFE"]    = {"Q"};
                gate_to_regular_output_ports["SB_DFFSR"]   = {"Q"};
                gate_to_regular_output_ports["SB_DFFR"]    = {"Q"};
                gate_to_regular_output_ports["SB_DFFSS"]   = {"Q"};
                gate_to_regular_output_ports["SB_DFFS"]    = {"Q"};
                gate_to_regular_output_ports["SB_DFFESR"]  = {"Q"};
                gate_to_regular_output_ports["SB_DFFER"]   = {"Q"};
                gate_to_regular_output_ports["SB_DFFESS"]  = {"Q"};
                gate_to_regular_output_ports["SB_DFFES"]   = {"Q"};
                gate_to_regular_output_ports["SB_DFFN"]    = {"Q"};
                gate_to_regular_output_ports["SB_DFFNE"]   = {"Q"};
                gate_to_regular_output_ports["SB_DFFNSR"]  = {"Q"};
                gate_to_regular_output_ports["SB_DFFNR"]   = {"Q"};
                gate_to_regular_output_ports["SB_DFFNSS"]  = {"Q"};
                gate_to_regular_output_ports["SB_DFFNS"]   = {"Q"};
                gate_to_regular_output_ports["SB_DFFNESR"] = {"Q"};
                gate_to_regular_output_ports["SB_DFFNER"]  = {"Q"};
                gate_to_regular_output_ports["SB_DFFNESS"] = {"Q"};
                gate_to_regular_output_ports["SB_DFFNES"]  = {"Q"};
            }

            return gate_to_regular_output_ports.at(g->get_name());
        }

        std::unordered_set<std::string> UtilsiCE40Ultra::get_negated_outputs(GateType* g) const
        {
            if (!is_sequential(g))
            {
                log_error("gl specifics", "gate type is not sequential: type: {}", g->get_name());
            ...
            {
                gate_to_negated_output_ports["SB_DFF"]     = {};
                gate_to_negated_output_ports["SB_DFFE"]    = {};
                gate_to_negated_output_ports["SB_DFFSR"]   = {};
                gate_to_negated_output_ports["SB_DFFR"]    = {};
                gate_to_negated_output_ports["SB_DFFSS"]   = {};
                gate_to_negated_output_ports["SB_DFFS"]    = {};
                gate_to_negated_output_ports["SB_DFFESR"]  = {};
                gate_to_negated_output_ports["SB_DFFER"]   = {};
                gate_to_negated_output_ports["SB_DFFESS"]  = {};
                gate_to_negated_output_ports["SB_DFFES"]   = {};
                gate_to_negated_output_ports["SB_DFFN"]    = {};
                gate_to_negated_output_ports["SB_DFFNE"]   = {};
                gate_to_negated_output_ports["SB_DFFNSR"]  = {};
                gate_to_negated_output_ports["SB_DFFNR"]   = {};
                gate_to_negated_output_ports["SB_DFFNSS"]  = {};
                gate_to_negated_output_ports["SB_DFFNS"]   = {};
                gate_to_negated_output_ports["SB_DFFNESR"] = {};
                gate_to_negated_output_ports["SB_DFFNER"]  = {};
                gate_to_negated_output_ports["SB_DFFNESS"] = {};
                gate_to_negated_output_ports["SB_DFFNES"]  = {};
            }
