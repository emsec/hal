...
namespace hal
{
    namespace z3_utils
    {
        std::string CppBitslicedConverter::build_operand(const std::string& operand) const
        {
        ...
        std::string CppBitslicedConverter::build_operation(const Converter::Operation& operation, const std::vector<std::string>& operands) const
        {
            std::string op;
        ...
        std::string CppBitslicedConverter::generate_assignment(const std::string& l) const
        {
        ...
        std::string CppBitslicedConverter::generate_initialization(const std::vector<std::string>& input_vars) const
        {
            std::string init = "";
        ...
        std::string CppBitslicedConverter::construct_function(const std::string& assignments, const std::string& initalization, const std::vector<std::string>& input_vars) const
        {
            ...
            const auto last_assigment_pos = assignments.rfind("uint64_t") + 9;    // length of "uint64_t" + one space
