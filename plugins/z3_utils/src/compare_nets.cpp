...
namespace hal
{
    namespace z3_utils
    {
       bool compare_nets(const Netlist* netlist_a, const Netlist* netlist_b, const Net* net_a, const Net* net_b, bool replace_net_ids) {
            ...
            sfg.get_subgraph_z3_function(net_a, gates_a, ctx, bf_a, input_net_ids_a);
            sfg.get_subgraph_z3_function(net_b, gates_b, ctx, bf_b, input_net_ids_b);
