...
namespace hal
{
    GraphicsGate::GraphicsGate(Gate* g) : GraphicsNode(item_type::Gate, g->get_id(), QString::fromStdString(g->get_name())), m_type(QString::fromStdString(g->get_type()->get_name()))
    {
