...
namespace hal
{
    ...
    PYBIND11_PLUGIN(module_identification)
    {
        ...
        py_result.def("get_all_gates", &module_identification::Result::get_all_gates, py::return_value_policy::reference_internal, R"(
        ...
        py_result.def("get_all_verified_gates", &module_identification::Result::get_all_verified_gates, py::return_value_policy::reference_internal, R"(
        ...
        py_verified_candidate.def_readwrite("output_nets", &module_identification::VerifiedCandidate::m_output_nets, py::return_value_policy::reference_internal, R"(
                A vector of output nets.
                
                :type: list[hal_py.Net]
            )");

        py_verified_candidate.def_readwrite("control_signals", &module_identification::VerifiedCandidate::m_control_signals, py::return_value_policy::reference_internal, R"(
        ...
        py_verified_candidate.def_readwrite("gates", &module_identification::VerifiedCandidate::m_gates, py::return_value_policy::reference_internal, R"(
                A vector of gates associated with the candidate.
                
                :type: list[hal_py.Gate]
            )");

        py_verified_candidate.def_readwrite("base_gates", &module_identification::VerifiedCandidate::m_base_gates, py::return_value_policy::reference_internal, R"(
                A vector of base gates associated with the candidate.
                
                :type: list[hal_py.Gate]
            )");

        py_verified_candidate.def_readwrite("total_input_nets", &module_identification::VerifiedCandidate::m_total_input_nets, py::return_value_policy::reference_internal, R"(
                A vector of all input nets to the gate subgraph, regardless of whether they appear in a word-level operation or not.
                
                :type: list[hal_py.Net]
            )");

        py_verified_candidate.def_readwrite("total_output_nets", &module_identification::VerifiedCandidate::m_total_output_nets, py::return_value_policy::reference_internal, R"(
