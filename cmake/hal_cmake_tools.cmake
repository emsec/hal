...
function(setup_output_directories)
    ...
    foreach(i IN ITEMS "RUNTIME" "ARCHIVE" "LIBRARY")
        ...
        if(NOT CMAKE_${i}_OUTPUT_DIRECTORY)
            ...
            set(CMAKE_${i}_OUTPUT_DIRECTORY "${CMAKE_${i}_OUTPUT_DIRECTORY}" PARENT_SCOPE)
    ...
    foreach(i IN ITEMS "_DEBUG" "_RELEASE" "_MINSIZEREL" "_RELWITHDEBINFO")
        foreach(j IN ITEMS "RUNTIME" "ARCHIVE" "LIBRARY")
            if(NOT CMAKE_${j}_OUTPUT_DIRECTORY${i})
                ...
                set(CMAKE_${j}_OUTPUT_DIRECTORY${i} ${CMAKE_${j}_OUTPUT_DIRECTORY${i}} PARENT_SCOPE)
    ...
    set(INCLUDE_INSTALL_DIRECTORY ${INCLUDE_INSTALL_DIRECTORY} PARENT_SCOPE)
    ...
    set(INCLUDE_INSTALL_DIRECTORY_FULL ${INCLUDE_INSTALL_DIRECTORY_FULL} PARENT_SCOPE)
    ...
    set(SHARE_INSTALL_DIRECTORY ${SHARE_INSTALL_DIRECTORY} PARENT_SCOPE)
    ...
    set(SHARE_INSTALL_DIRECTORY_FULL ${SHARE_INSTALL_DIRECTORY_FULL} PARENT_SCOPE)
    ...
    set(PKGCONFIG_INSTALL_DIRECTORY ${PKGCONFIG_INSTALL_DIRECTORY} PARENT_SCOPE)
    message(VERBOSE "PKGCONFIG_INSTALL_DIRECTORY: ${PKGCONFIG_INSTALL_DIRECTORY}")

    set(BINARY_INSTALL_DIRECTORY ${CMAKE_INSTALL_BINDIR})
    set(BINARY_INSTALL_DIRECTORY ${BINARY_INSTALL_DIRECTORY} PARENT_SCOPE)
    ...
    set(BINARY_INSTALL_DIRECTORY_FULL ${BINARY_INSTALL_DIRECTORY_FULL} PARENT_SCOPE)
    ...
    set(LIBRARY_INSTALL_DIRECTORY ${LIBRARY_INSTALL_DIRECTORY} PARENT_SCOPE)
    ...
    set(LIBRARY_INSTALL_DIRECTORY_FULL ${LIBRARY_INSTALL_DIRECTORY_FULL} PARENT_SCOPE)
    ...
    set(PLUGIN_INCLUDE_INSTALL_DIRECTORY ${PLUGIN_INCLUDE_INSTALL_DIRECTORY} PARENT_SCOPE)
    ...
    set(PLUGIN_BINARY_INSTALL_DIRECTORY ${PLUGIN_BINARY_INSTALL_DIRECTORY} PARENT_SCOPE)
    ...
    set(PLUGIN_LIBRARY_INSTALL_DIRECTORY ${PLUGIN_LIBRARY_INSTALL_DIRECTORY} PARENT_SCOPE)
