...
if [[ "$platform" == 'macOS' ]]; then
    ...
    if [[ "$distribution" == 'Ubuntu' ]]; then
        ...
        libpython3.7-dev build-essential ccache autoconf autotools-dev \
        libqt5svg5-dev libqt5svg5* ninja-build lcov gcovr python3-sphinx doxygen python3-sphinx-rtd-theme python3-jedi python3-pip
