    ...
    namespace test_utils
    {
        std::unique_ptr<GateLibrary> create_gate_library(const std::filesystem::path& file_path)
        {
            std::unique_ptr<GateLibrary> lib = std::unique_ptr<GateLibrary>(new GateLibrary(file_path, "TESTING_GATE_LIBRARY"));
            {
                ...
                gnd->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("0")));
            ...
            }
            {
                ...
                vcc->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("1")));
            ...
            }
            {
                ...
                buf->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I")));
            }
            {
            ...
            }
            {
                ...
                and2->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 & I1")));
            }
            {
                ...
                and3->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 & I1 & I2")));
            }
            {
                ...
                and4->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 & I1 & I2 & I3")));
            }
            {
                ...
                or2->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 | I1")));
            }
            {
                ...
                or3->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 | I1 | I2")));
            }
            {
                ...
                or4->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 | I1 | I2 | I3")));
            }
            {
            ...
            }
            {
                ...
                carry->add_boolean_function("CO", std::get<BooleanFunction>(BooleanFunction::from("(I0 & I1) | ((I0 | I1) & CI)")));
            }
            {
                GateType* dff = lib->create_gate_type("DFF", {GateTypeProperty::sequential, GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), std::get<BooleanFunction>(BooleanFunction::from("D")), std::get<BooleanFunction>(BooleanFunction::from("CLK"))));
            ...
            {
                GateType* dff_e = lib->create_gate_type("DFFE", {GateTypeProperty::sequential, GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), std::get<BooleanFunction>(BooleanFunction::from("D")), std::get<BooleanFunction>(BooleanFunction::from("CLK & EN"))));
            ...
            {
                GateType* dff_s = lib->create_gate_type("DFFS", {GateTypeProperty::sequential, GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), std::get<BooleanFunction>(BooleanFunction::from("D")), std::get<BooleanFunction>(BooleanFunction::from("CLK"))));
                ...
                ff_component->set_async_set_function(std::get<BooleanFunction>(BooleanFunction::from("S")));
            ...
            {
                GateType* dff_r = lib->create_gate_type("DFFR", {GateTypeProperty::sequential, GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), std::get<BooleanFunction>(BooleanFunction::from("D")), std::get<BooleanFunction>(BooleanFunction::from("CLK"))));
                ...
                assert(ff_component != nullptr);
                ff_component->set_async_reset_function(std::get<BooleanFunction>(BooleanFunction::from("R")));
            ...
            {
                GateType* dff_rs = lib->create_gate_type("DFFRS", {GateTypeProperty::sequential, GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), std::get<BooleanFunction>(BooleanFunction::from("D")), std::get<BooleanFunction>(BooleanFunction::from("CLK"))));
            ...
            {
                GateType* dff_se = lib->create_gate_type("DFFSE", {GateTypeProperty::sequential, GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), std::get<BooleanFunction>(BooleanFunction::from("D")), std::get<BooleanFunction>(BooleanFunction::from("CLK & EN"))));
            ...
            {
                GateType* dff_re = lib->create_gate_type("DFFRE", {GateTypeProperty::sequential, GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), std::get<BooleanFunction>(BooleanFunction::from("D")), std::get<BooleanFunction>(BooleanFunction::from("CLK & EN"))));
            ...
            {
                GateType* dff_rse = lib->create_gate_type("DFFRSE", {GateTypeProperty::sequential, GateTypeProperty::ff}, GateTypeComponent::create_ff_component(GateTypeComponent::create_state_component(nullptr, "IQ", "IQN"), std::get<BooleanFunction>(BooleanFunction::from("D")), std::get<BooleanFunction>(BooleanFunction::from("CLK & EN"))));
