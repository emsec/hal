...
namespace hal {
    ...
    using test_utils::INVALID_GATE_ID;
    using test_utils::INVALID_NET_ID;
    using test_utils::INVALID_MODULE_ID;
    using test_utils::INVALID_GROUPING_ID;
        ...
        TEST_START
            {
                ...
                EXPECT_EQ(test_grouping->get_id(), (u32)(MIN_GROUPING_ID));
            ...
            }
            {
                // Creating a grouping with ID 123 and name "test_grouping"
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(MIN_GROUPING_ID + 123, "test_grouping");

                EXPECT_EQ(test_grouping->get_id(), (u32)(MIN_GROUPING_ID + 123));
                EXPECT_EQ(test_grouping->get_name(), "test_grouping");
                EXPECT_EQ(test_grouping->get_netlist(), nl.get());
            }
            // NEGATIVE
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(INVALID_GROUPING_ID, "test_grouping");
        ...
        TEST_START
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(MIN_GROUPING_ID + 0, "test_grouping");
            ...
            }
            {
                ...
                test_grouping->set_name("test_grouping");
                EXPECT_EQ(test_grouping->get_name(), "test_grouping");
            }
            {
                // Set an empty name
        ...
        TEST_START
            {
                ...
                Gate* gate_0 = nl->create_gate(MIN_GATE_ID + 0, test_utils::get_gate_type_by_name("gate_1_to_1"), "gate_0");
                Gate* gate_1 = nl->create_gate(MIN_GATE_ID + 1, test_utils::get_gate_type_by_name("gate_1_to_1"), "gate_1");
                Gate* gate_2 = nl->create_gate(MIN_GATE_ID + 2, test_utils::get_gate_type_by_name("gate_1_to_1"), "gate_2");
                ...
                std::vector<u32> exp_res_1 = {MIN_GATE_ID + 0, MIN_GATE_ID + 1, MIN_GATE_ID + 2};
    ...
    TEST_F(GroupingTest, check_contains_gate) {
        TEST_START
            // POSITIVE
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* g_0 = nl->create_grouping(MIN_GROUPING_ID + 0, "test_grouping");
                Gate* gate_0 = nl->create_gate(MIN_GATE_ID + 0, test_utils::get_gate_type_by_name("gate_1_to_1"), "gate_0");
                g_0->assign_gate(gate_0);

                EXPECT_TRUE(g_0->contains_gate(gate_0));
                EXPECT_TRUE(g_0->contains_gate_by_id(MIN_GATE_ID + 0));
            }
            {
                ...
                EXPECT_FALSE(g_0->contains_gate_by_id(MIN_GATE_ID + 0));
            }
        TEST_END
    }
        ...
        TEST_START
            {
                ...
                Gate* gate_1 = nl->create_gate(MIN_GATE_ID + 1, test_utils::get_gate_type_by_name("gate_1_to_1"), "gate_1");
                Gate* gate_2 = nl->create_gate(MIN_GATE_ID + 2, test_utils::get_gate_type_by_name("gate_1_to_1"), "gate_2");
                Gate* gate_3 = nl->create_gate(MIN_GATE_ID + 3, test_utils::get_gate_type_by_name("gate_1_to_1"), "gate_3");
                ...
                grouping_1->assign_gate_by_id(MIN_GATE_ID + 2);
                grouping_1->assign_gate_by_id(MIN_GATE_ID + 3);
            ...
            }
            {
                ...
                test_grouping->assign_gate(gate_0);
                test_grouping->assign_gate(gate_0);
                test_grouping->assign_gate_by_id(MIN_GATE_ID + 1);
                test_grouping->assign_gate_by_id(MIN_GATE_ID + 1);
            ...
            }
            {
                ...
                grouping_0->assign_gate(gate_0);
                grouping_0->assign_gate_by_id(MIN_GATE_ID + 1);
                ...
                grouping_1->assign_gate_by_id(MIN_GATE_ID + 1);
                EXPECT_EQ(grouping_0->get_gates(), exp_res_0);
                EXPECT_FALSE(grouping_1->contains_gate(gate_0));
                EXPECT_FALSE(grouping_1->contains_gate(gate_1));

                grouping_1->assign_gate_by_id(MIN_GATE_ID + 1, true);
            ...
            }
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(MIN_GROUPING_ID + 0, "test_grouping");
                test_grouping->assign_gate_by_id(INVALID_GATE_ID);
                EXPECT_TRUE(test_grouping->get_gates().empty());
            }
            {
            ...
            }
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(MIN_GROUPING_ID + 0, "test_grouping");
                EXPECT_FALSE(test_grouping->contains_gate_by_id(INVALID_GATE_ID));
            }
        TEST_END
    }
        ...
        TEST_START
            {
                ...
                test_grouping->remove_gate_by_id(MIN_GATE_ID + 1);
            ...
            }
            {
                ...
                grouping_0->remove_gate_by_id(MIN_GATE_ID + 1);
                EXPECT_FALSE(grouping_0->contains_gate(gate_0));
            ...
            }
            {
                ...
                test_grouping->remove_gate_by_id(INVALID_GATE_ID);
            }
        TEST_END
    }
        ...
        TEST_START
            {
                ...
                Net* net_1 = nl->create_net(MIN_NET_ID + 1, "net_1");
                Net* net_2 = nl->create_net(MIN_NET_ID + 2, "net_2");
                ...
                std::vector<u32> exp_res_1 = {MIN_NET_ID + 0, MIN_NET_ID + 1, MIN_NET_ID + 2};
    ...
    TEST_F(GroupingTest, check_contains_net) {
        TEST_START
            // POSITIVE
            {
                ...
                EXPECT_TRUE(g_0->contains_net_by_id(MIN_NET_ID + 0));
            }
            {
                // Check a Gate that isn't part of the grouping
                auto nl = test_utils::create_empty_netlist();
                ...
                EXPECT_FALSE(g_0->contains_net_by_id(MIN_NET_ID + 0));
            }
        TEST_END
    }
        ...
        TEST_START
            {
                ...
                Net* net_1 = nl->create_net(MIN_NET_ID + 1, "net_1");
                Net* net_2 = nl->create_net(MIN_NET_ID + 2, "net_2");
                Net* net_3 = nl->create_net(MIN_NET_ID + 3, "net_3");
                ...
                Grouping* grouping_1 = nl->create_grouping(MIN_GROUPING_ID + 1, "grouping_1");
                grouping_1->assign_net_by_id(MIN_NET_ID + 2);
                grouping_1->assign_net_by_id(MIN_NET_ID + 3);
            ...
            }
            {
                ...
                test_grouping->assign_net(net_0);
                test_grouping->assign_net(net_0);
                test_grouping->assign_net_by_id(MIN_NET_ID + 1);
                test_grouping->assign_net_by_id(MIN_NET_ID + 1);
            ...
            }
            {
                ...
                grouping_0->assign_net(net_0);
                grouping_0->assign_net_by_id(MIN_NET_ID + 1);
                ...
                grouping_1->assign_net_by_id(MIN_NET_ID + 1);
                EXPECT_EQ(grouping_0->get_nets(), exp_res_0);
                EXPECT_FALSE(grouping_1->contains_net(net_0));
                EXPECT_FALSE(grouping_1->contains_net(net_1));

                grouping_1->assign_net_by_id(MIN_NET_ID + 1, true);
            ...
            }
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(MIN_GROUPING_ID + 0, "test_grouping");
                test_grouping->assign_gate_by_id(INVALID_NET_ID);
                EXPECT_TRUE(test_grouping->get_nets().empty());
            }
            {
            ...
            }
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(MIN_GROUPING_ID + 0, "test_grouping");
                EXPECT_FALSE(test_grouping->contains_net_by_id(INVALID_NET_ID));
            }
        TEST_END
    }
        ...
        TEST_START
            {
                ...
                test_grouping->remove_net_by_id(MIN_NET_ID + 1);
            ...
            }
            {
                ...
                grouping_0->remove_net_by_id(MIN_NET_ID + 1);
                EXPECT_FALSE(grouping_0->contains_net(net_0));
            ...
            }
            {
                ...
                test_grouping->remove_net_by_id(INVALID_NET_ID);
            }
        TEST_END
    }
        ...
        TEST_START
            {
                ...
                Module* module_0 = nl->create_module(MIN_MODULE_ID + 0, "module_0", nl->get_top_module());
                Module* module_1 = nl->create_module(MIN_MODULE_ID + 1, "module_1", nl->get_top_module());
                Module* module_2 = nl->create_module(MIN_MODULE_ID + 2, "module_2", nl->get_top_module());
                ...
                std::vector<u32> exp_res_1 = {MIN_MODULE_ID + 0, MIN_MODULE_ID + 1, MIN_MODULE_ID + 2};
    ...
    TEST_F(GroupingTest, check_contains_module) {
        TEST_START
            // POSITIVE
            {
                ...
                EXPECT_TRUE(g_0->contains_module_by_id(MIN_MODULE_ID + 0));
            }
            {
                // Check a Gate that isn't part of the grouping
                auto nl = test_utils::create_empty_netlist();
                ...
                EXPECT_FALSE(g_0->contains_module_by_id(MIN_MODULE_ID + 0));
            }
        TEST_END
    }
        ...
        TEST_START
            {
                ...
                Module* module_1 = nl->create_module(MIN_MODULE_ID + 1, "module_1", nl->get_top_module());
                Module* module_2 = nl->create_module(MIN_MODULE_ID + 2, "module_2", nl->get_top_module());
                Module* module_3 = nl->create_module(MIN_MODULE_ID + 3, "module_3", nl->get_top_module());
                ...
                Grouping* grouping_1 = nl->create_grouping(MIN_GROUPING_ID + 1, "grouping_1");
                grouping_1->assign_module_by_id(MIN_MODULE_ID + 2);
                grouping_1->assign_module_by_id(MIN_MODULE_ID + 3);
            ...
            }
            {
                ...
                test_grouping->assign_module(module_0);
                test_grouping->assign_module(module_0);
                test_grouping->assign_module_by_id(MIN_MODULE_ID + 1);
                test_grouping->assign_module_by_id(MIN_MODULE_ID + 1);
            ...
            }
            {
                ...
                grouping_0->assign_module(module_0);
                grouping_0->assign_module_by_id(MIN_MODULE_ID + 1);
                ...
                grouping_1->assign_module_by_id(MIN_MODULE_ID + 1);
                EXPECT_EQ(grouping_0->get_modules(), exp_res_0);
                EXPECT_FALSE(grouping_1->contains_module(module_0));
                EXPECT_FALSE(grouping_1->contains_module(module_1));

                grouping_1->assign_module_by_id(MIN_MODULE_ID + 1, true);
            ...
            }
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(MIN_GROUPING_ID + 0, "test_grouping");
                test_grouping->assign_gate_by_id(INVALID_MODULE_ID);
                EXPECT_TRUE(test_grouping->get_modules().empty());
            }
            {
            ...
            }
            {
                ...
                auto nl = test_utils::create_empty_netlist();
                Grouping* test_grouping = nl->create_grouping(MIN_GROUPING_ID + 0, "test_grouping");
                EXPECT_FALSE(test_grouping->contains_module_by_id(INVALID_MODULE_ID));
            }
        TEST_END
    }
        ...
        TEST_START
            {
                ...
                test_grouping->remove_module_by_id(MIN_MODULE_ID + 1);
            ...
            }
            {
                ...
                grouping_0->remove_module_by_id(MIN_MODULE_ID + 1);
                EXPECT_FALSE(grouping_0->contains_module(module_0));
            ...
            }
            {
                ...
                test_grouping->remove_module_by_id(INVALID_GATE_ID);
            }
        TEST_END
    }
