...
namespace hal
{
    ...
    TEST_F(NetlistUtilsTest, check_get_subgraph_function)
    {
        ...
        gate_3->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("!I")));
...

        {
            ...
            BooleanFunction expected_bf = std::get<BooleanFunction>(BooleanFunction::from(("!" + net_13_name + " & " + net_20_name)));
        ...
        }
        {
            ...
            BooleanFunction expected_bf = std::get<BooleanFunction>(BooleanFunction::from((net_30_name + " & " + net_20_name)));
    ...
    TEST_F(NetlistUtilsTest, check_copy_netlist)
    {
        ...
        test_nl->get_gate_by_id(MIN_GATE_ID + 0)->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 & I1")));
        test_nl->get_gate_by_id(MIN_GATE_ID + 4)->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("!I")));
    ...
    TEST_F(NetlistUtilsTest, check_remove_unused_lut_endpoints)
    {
        TEST_START
        {
            ...
            l4->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 & I1 & I2 & I3")));
