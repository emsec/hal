...
namespace hal
{
    ...
    TEST_F(GateLibraryTest, check_library)
    {
        TEST_START
        {
            ...
            gt_and->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 & I1")));
            ...
            gt_or->add_boolean_function("O", std::get<BooleanFunction>(BooleanFunction::from("I0 | I1")));
