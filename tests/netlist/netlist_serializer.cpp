    ...
    protected:
        ...
        */
        std::unique_ptr<Netlist> create_example_serializer_netlist() 
        {
            ...
            test_m_0->change_port_name(test_m_0->get_port_by_net(net_1_3), "test_m_0_net_1_3_in");
            test_m_0->change_port_name(test_m_0->get_port_by_net(net_2_0), "test_m_0_net_2_0_in");
            test_m_0->assign_port_group("great_group", {{0, test_m_0->get_port_by_net(net_1_3)}, {1, test_m_0->get_port_by_net(net_2_0)}});
            test_m_0->change_port_name(test_m_0->get_port_by_net(net_0_4_5), "test_m_0_net_0_4_5_out");
            test_m_1->change_port_name(test_m_1->get_port_by_net(net_1_3), "test_m_1_net_1_3_out");
    ...
    TEST_F(NetlistSerializerTest, check_serialize_and_deserialize) {
        TEST_START
            ...
            }
            {
                ...
                // Set some input/output port names of module 0
                test_m_0_flipped->change_port_name(test_m_0_flipped->get_port_by_net(nl->get_net_by_id(13)), "test_m_0_flipped_net_1_3_in");
                test_m_0_flipped->change_port_name(test_m_0_flipped->get_port_by_net(nl->get_net_by_id(20)), "test_m_0_flipped_net_2_0_in");
                test_m_0_flipped->change_port_name(test_m_0_flipped->get_port_by_net(nl->get_net_by_id(45)), "test_m_0_flipped_net_0_4_5_out");
                test_m_1_flipped->change_port_name(test_m_1_flipped->get_port_by_net(nl->get_net_by_id(13)), "test_m_1_flipped_net_1_3_out");
