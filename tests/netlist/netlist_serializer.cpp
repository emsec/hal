...
namespace hal
{
     ...
     */
    TEST_F(NetlistSerializerTest, check_serialize_and_deserialize){TEST_START{// Serialize and deserialize the example netlist (with some additions) and compare the result with the original netlist
...
TEST_F(NetlistSerializerTest, check_serialize_and_deserialize_negative)
{
    ...
    }
    {
        ...
        NO_COUT_TEST_BLOCK;
        auto des_nl = netlist_serializer::deserialize_from_file(std::filesystem::path("/using/this/file/is/let.hal"));
