...
namespace hal
{
    ...
    TEST_F(GateTest, check_operators)
    {
        TEST_START
        {
            ...
            nl1_g12->add_boolean_function("test", std::get<BooleanFunction>(BooleanFunction::from("A & B")));
            Gate* nl2_g12 = nl_2->create_gate(12, gl->get_gate_type_by_name("AND2"), "gate_12");
            ASSERT_NE(nl2_g12, nullptr);
            nl2_g12->add_boolean_function("test", std::get<BooleanFunction>(BooleanFunction::from("A & B")));
            Gate* nl1_g13 = nl_1->create_gate(13, gl->get_gate_type_by_name("AND2"), "gate_13");
            ASSERT_NE(nl1_g13, nullptr);
            nl1_g13->add_boolean_function("test", std::get<BooleanFunction>(BooleanFunction::from("A & B")));
            ...
            nl1_g14->add_boolean_function("test", std::get<BooleanFunction>(BooleanFunction::from("A & B")));
            Gate* nl2_g14 = nl_2->create_gate(14, gl->get_gate_type_by_name("AND2"), "gate_14");
            ASSERT_NE(nl2_g14, nullptr);
            nl2_g14->add_boolean_function("test", std::get<BooleanFunction>(BooleanFunction::from("A | B")));
    ...
    TEST_F(GateTest, check_boolean_function_access)
    {
        TEST_START
        {
            ...
            EXPECT_EQ(functions, (std::unordered_map<std::string, BooleanFunction>({{"O", std::get<BooleanFunction>(BooleanFunction::from("!I"))}})));
    ...
    TEST_F(GateTest, check_lut_function) {
        ...
        }
        {
            ...
            BooleanFunction lut_bf = std::get<BooleanFunction>(BooleanFunction::from("(I0 & I1) & I2"));
